...
STEPS = [
    # ===== ЦИКЛ 1: ПЛОЩАДЬ ЛЕНИНА =====
    {
        ...
        "success_text": "Принято. Это Площадь Ленина. Двигайся туда.",
    ...
    },
    {
        ...
        "prompt": (
            "Мини-задание.\n"
            "Пин код для продложения - год установки. Введи его сюда."
        ),
        "pins": ["1926"],
        "success_text": (
    ...
    },
    {
        ...
        "prompt": (
            "В KetchUp Burgers скажи на входе пароль:\n"
            "«А самолёт летит — колёса тёрлися, а вы не ждали нас, а мы припёрлися».\n\n"
            "Тебе дадут конверт в паролем для слеюудщего задания и поможет бесплатно заказать маленький бургер. Когда его принесут бургер:\n"
    ...
    },
    {
        ...
        "prompt": (
            "Мини-задание.\n"
            "В конверте, который тебе выдали в KetchUp, есть PIN-код.\n"
            "Введи его сюда."
        ),
        "pins": ["0512"],
        "success_text": (
            "PIN 0512 принят. Штаб доволен.\n"
            "Теперь слушай новую легенду...."
        ),
    ...
    },
    {
        ...
        "prompt": (
            "Мини-задание.\n"
            "На табличке у Адмиралтейства найди год постройки. Введи его сюда."
        ),
        "pins": ["1811"],
        "success_text": (
    ...
    },
    {
        ...
        "prompt": (
            ...
            "Отправь её полностью (можно без точки в конце)."
        ),
        "pins": [
    ...
    },
    {
        ...
        "prompt": (
            "Теперь последняя точка.\n\n"
            "Найди ёлку у ТЦ и запиши голосовое сообщение сюда со словами:\n"
            "«ТТ БУБУ на месте, где контейнер?».\n\n"
            "После этого один подозрительный человек должен вручить тебе груз."
        ),
    },
]
...
async def handle_approve_reject(call: types.CallbackQuery):
    if call.from_user.id != ADMIN_ID:
        await call.answer("Ты не главнокомандующий ТТ БУБУ.")
        return
    ...
    if action == "reject":
        ...
        await bot.send_message(
            ...
            "Попробуй ещё раз — поближе, чётче, с душой."
        )
        return
    ...
    if action == "approve":
        ...
        await bot.send_message(
            target_user_id,
            "Штаб ТТ БУБУ: медиа одобрено. Переходим дальше."
        )
