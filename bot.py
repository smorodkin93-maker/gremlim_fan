...
STEPS = [
    ...
    },
    {
        ...
        "prompt": (
            ...
            "Тебе дадут конверт с паролем для слеюудщего задания, он тебе пригодится чуть позже. Тебе помогут заказать бургер или что-то похожее. Когда его принесут:\n\n"
            "1) Попроси официанта снять тебя на видео.\n"
            "2) Пока ты ешь, произнеси на видео так, вы вырожением и с расстановкой:\n"
...
async def handle_start(message: types.Message):
    ...
    greeting = (
        "Если ты читаешь это, значит уже нашел инстуркцию у гидры и готов к операции БУ.\n\n"
