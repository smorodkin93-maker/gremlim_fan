...
STEPS = [
    ...
    },
    {
        ...
        "prompt": (
            ...
            "Тебе дадут конверт с паролем для слеюудщего задания и поможет бесплатно заказать маленький бургер. Когда его принесут бургер:\n"
    ...
    },
    {
        ...
        "pins": ["05122022"],
        "success_text": (
            "PIN 05122022 принят. Штаб доволен.\n"
            "Теперь слушай новую легенду...."
        ),
    ...
    },
    {
        ...
        "prompt": (
            ...
            "«Отправь фото сюда. Штаб отправяет агента на вручение контейнера.».\n\n"
